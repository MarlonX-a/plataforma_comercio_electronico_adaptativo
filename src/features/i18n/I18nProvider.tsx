...
const translations = {
  es: {
    ...
    'layout.page.workerProducts': 'Panel de productos',
    'layout.page.sellerProducts': 'Panel de vendedor',
    'layout.page.addProduct': 'Agregar producto',
    ...
    'navbar.nav.addProduct': 'Agregar producto',
    ...
    'navbar.workerPanel': 'Panel tienda',
    'navbar.addProduct': 'Agregar producto',
  ...
  en: {
    ...
    'layout.page.workerProducts': 'Product dashboard',
    'layout.page.sellerProducts': 'Seller dashboard',
    'layout.page.addProduct': 'Add product',
    ...
    'navbar.nav.addProduct': 'Add product',
    ...
    'navbar.workerPanel': 'Store panel',
    'navbar.addProduct': 'Add product',
  ...
  pt: {
    ...
    'layout.page.workerProducts': 'Painel de produtos',
    'layout.page.sellerProducts': 'Painel do vendedor',
    'layout.page.addProduct': 'Adicionar produto',
    ...
    'navbar.nav.orders': 'Pedidos',
    'navbar.nav.addProduct': 'Adicionar produto',
    ...
    'navbar.workerPanel': 'Painel da loja',
    'navbar.addProduct': 'Adicionar produto',
  ...
  fr: {
    ...
    'layout.page.workerProducts': 'Tableau des produits',
    'layout.page.sellerProducts': 'Espace vendeur',
    'layout.page.addProduct': 'Ajouter un produit',
    ...
    'navbar.nav.addProduct': 'Ajouter un produit',
    ...
    'navbar.workerPanel': 'Espace boutique',
    'navbar.addProduct': 'Ajouter un produit',
